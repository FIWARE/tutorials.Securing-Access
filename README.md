...
The [User Gredentials](https://tools.ietf.org/html/rfc6749#section-1.3.3) grant flow, also known as the *resource owner password credentials grant* or password grant should only be used when:
